...
from utils import generate_table_dict, parse_table_from_dataframe, compute_bag_intersection, to_bag_counter
from testing_tables.test_tables import table_sport_a, table_sport_b
...
def sloth(r_tab, s_tab, min_a=0, min_w=0, max_w=math.inf, min_h=0, max_h=math.inf, bw=var.default_bw, complete=False,
    ...
    # print(list(compute_bag_intersection(r_tab, s_tab, results[0], seeds).elements()))
...
# results, metrics = sloth(table_sport_a, table_sport_b, verbose=False, metrics=[])
# print('num_seeds:', metrics[0])
# print('algo:', metrics[2])
# print('overlap:', metrics[12])
# print('time:', metrics[13])
# print('num ver cands:', metrics[7])
# print('verified time:', metrics[8])


# r_tab = pd.read_csv('/Users/davidelupo/Desktop/sloth-main/Dataset/wikitables/test/tables/130.76234.csv',header=None)
# r_tab_col_list = parse_table_from_dataframe(r_tab)
# s_tab = pd.read_csv('/Users/davidelupo/Desktop/sloth-main/Dataset/wikitables/test/tables/347.91928.csv',header=None)
...
results, metrics = sloth(table_sport_a, table_sport_b, verbose=True, metrics=[])
print('num_seeds:', metrics[0])
print('algo:', metrics[2])
print('overlap:', metrics[12])
print('time:', metrics[13])
...
# n_samples = 2000
# # sloth_csv = pd.read_csv(path_dataset+'/wikitables/test.csv')[['r_id','s_id','seeds','a%','sloth_time']].head(n_samples)
# sloth_csv = pd.read_csv(path_dataset+'/gittables/test.csv')[['r_id','s_id','seeds','a%','total_time']].head(n_samples)
# ids_to_keep = set(sloth_csv['r_id']).union(set(sloth_csv['s_id']))
# # tables_dict = generate_table_dict(path_dataset+'/wikitables/test', ids_to_keep)
# tables_dict = generate_table_dict(path_dataset+'/gittables/test', ids_to_keep)
...
#     s_tab_col_list = parse_table_from_dataframe(s_tab)
#     _, metrics = sloth(r_tab_col_list, s_tab_col_list, verbose=True, metrics=[])
...
# df_results = pd.DataFrame({'r_id': list(sloth_csv['r_id']), 's_id': list(sloth_csv['s_id']), 
...
# # df_results.to_csv(f'test_sloth_wiki_{n_samples}samples.csv', sep=';', index=False)
# df_results.to_csv(f'test_sloth_git_{n_samples}samples.csv', sep=';', index=False)
